...
def parse_opt(known=False):
    ...
    # parser.add_argument('--cfg', type=str, default='', help='model.yaml path')  # change here 
    parser.add_argument('--cfg', type=str, default='models/my_yolov5s.yaml', help='model.yaml path')  
