...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="", help="models/sharpObj_yolov5s.yaml path")

    # parser.add_argument("--data", type=str, default=ROOT / "data/coco128.yaml", help="dataset.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/sharpObj.yaml", help="dataset.yaml path")
