...
#dddddddddddddddddddiff
    ...
    #mini_mec, senior_mec_bs, senior_mec_dl, top_mec_bs, top_mec_dl, senior_mec_EightDrive, flagship_mec_bs_robot,flagship_mec_dl_robot, top_mec_EightDrive,
    ...
    #mini_diff, senior_diff_robot,four_wheel_diff_bs ,four_wheel_diff_dl, 
    #brushless_senior_diff,flagship_four_wheel_diff_bs_robot,flagship_four_wheel_diff_dl_robot
